                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-02.55.16.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-03.52.54.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"style="background:#a5678e "><i class="far fa-heart"></i></a></li>
                                                        </ul>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-12.54.01.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"style="background:#a5678e "><i class="far fa-heart"></i></a></li>
                                                        </ul>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-12.56.04.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"style="background:#a5678e "><i class="far fa-heart"></i></a></li>
                                                        </ul>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-03.52.40.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"style="background:#a5678e "><i class="far fa-heart"></i></a></li>
                                                        </ul>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-03.52.13.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"style="background:#a5678e "><i class="far fa-heart"></i></a></li>
                                                        </ul>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-03.52.27.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"style="background:#a5678e "><i class="far fa-heart"></i></a></li>
                                                        </ul>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    ...
                                                    <p>It is a black box of photos and cards with flower... </p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    <h4>Red Box</h4>
                                                    <h5> <del>$ 60.00</del> $40.79</h5>
                                                    <p>It is a red box of photos and cards with calorfull foom balls...</p>
                                                    <a class="btn hvr-hover" href="user_page.php"style="background:#a5678e ">Buy Now</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    <h4>Love Box</h4>
                                                    <h5> <del>$ 60.00</del> $40.79</h5>
                                                    <p>It is a love box. It is very romantic gift...</p>
                                                    <a class="btn hvr-hover" href="user_page.php"style="background:#a5678e ">Buy Now</a>
                                                </div>
                                            </div>
                                        </div>
