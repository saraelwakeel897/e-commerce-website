            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="breadcrumb"style="background:#a5678e ">
                        ...
                        <li class="breadcrumb-item active">Mandala</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="product-item-filter row">
                            <div class="col-12 col-sm-8 text-center text-sm-left">
                                <div class="toolbar-sorter-right">
									...
									<option data-display="Select">Sara Ali</option>
								</select>
                                </div>
                                <p>Black & White Mandela</p>
                            </div>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-12.53.46.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-02.54.42.png" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                        ...
                                                        <a class="cart" href="#"style="background:#a5678e ">Buy Now</a>
                                                    </div>
                                                </div>
                                                <div class="why-text">
                                                    <h4>A Leaf Mandala</h4>
                                                    <h5> $9.79</h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-03.33.14.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"style="background:#a5678e "><i class="far fa-heart"></i></a></li>
                                                        </ul>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-02.55.51.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"style="background:#a5678e "><i class="far fa-heart"></i></a></li>
                                                        </ul>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-03.33.28.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"style="background:#a5678e "><i class="far fa-heart"></i></a></li>
                                                        </ul>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-03.34.03.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"style="background:#a5678e "><i class="far fa-heart"></i></a></li>
                                                        </ul>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-02.56.11.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"style="background:#a5678e "><i class="far fa-heart"></i></a></li>
                                                        </ul>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-02.56.22.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"style="background:#a5678e "><i class="far fa-heart"></i></a></li>
                                                        </ul>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    ...
                                                    <p>There are differant circles and butterfly drawing with mandala</p>
                                                    <a class="btn hvr-hover" href="#"style="background:#a5678e ">Buy Now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    <h4>Flower Mandala</h4>
                                                    <h5> <del>$ 60.00</del> $40.79</h5>
                                                    <p>It is a flower drawing with mandala</p>
                                                    <a class="btn hvr-hover" href="#"style="background:#a5678e ">Buy Now</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    <h4>Owl Mandala</h4>
                                                    <h5> <del>$ 60.00</del> $40.79</h5>
                                                    <p>It is an owl drawing with mandala</p>
                                                    <a class="btn hvr-hover" href="#">Buy Now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
