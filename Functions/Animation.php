                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-menu col-md-3">
                                            ...
                                            <div class="content">
                                                <ul class="menu-col">
                                                    <li><a href="Shop.php">Animation</a></li>
                        ...
                        <div class="product-item-filter row">
                            <div class="col-12 col-sm-8 text-center text-sm-left">
                                <div class="toolbar-sorter-right">
									...
									<option data-display="Select">Salsabil El-Gharably</option>
								</select>
                                </div>
                                <p>Animation & Portriat</p>
                            </div>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-12.54.38.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            
                                                            <li>
                                                                <a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist" style="background:#a5678e ">
                                            ...
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li>
                                                                <a href="#" style="background:#a5678e " data-toggle="tooltip" data-placement="right" title="Add to Wishlist">
                                                                    <i class="far fa-heart"></i>
                                                                </a>
                                                            </li>
                                                            </ul>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-02.50.36.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li>
                                                                <a href="#" style="background:#a5678e " data-toggle="tooltip" data-placement="right" title="Add to Wishlist">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-02.50.56.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li>
                                                                <a href="#" style="background:#a5678e " data-toggle="tooltip" data-placement="right" title="Add to Wishlist">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-02.51.30.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li>
                                                                <a href="#" style="background:#a5678e " data-toggle="tooltip" data-placement="right" title="Add to Wishlist">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-02.49.28.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li><a href="#" style="background:#a5678e " data-toggle="tooltip" data-placement="right" title="View"><i class="fas fa-heart"></i></a></li>
                                                            </ul>
                                                        <a class="cart" href="user_page.php" style="background:#a5678e ">Buy Now</a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-02.52.46.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li>
                                                                <a href="#" style="background:#a5678e " data-toggle="tooltip" data-placement="right" title="Add to Wishlist">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-02.45.03.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li><a href="#" style="background:#a5678e " data-toggle="tooltip" data-placement="right" title="View"><i class="fas fa-heart"></i></a></li>
                                                            </ul>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/PicsArt_12-16-02.51.13.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li>
                                                                <a href="#" style="background:#a5678e " style="background:#a5678e " data-toggle="tooltip" data-placement="right" title="Add to Wishlist">
                                                                    <i class="far fa-heart"></i>
                                                                </a>
                                                            </li>
                                                            </ul>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="products-single fix">
                                                    <div class="box-img-hover">
                                                        ...
                                                        <div class="mask-icon">
                                                            <ul>
                                                                <li>
                                                                <a href="#" data-toggle="tooltip" style="background:#a5678e " data-placement="right" title="Add to Wishlist">
                                                                    <i class="far fa-heart"></i>
                                                                </a>
                                                            </li>
                                                                </ul>
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    ...
                                                    <p>It is a Chinese girl character...</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    <h4>Juice</h4>
                                                    <h5> <del>$ 60.00</del> $40.79</h5>
                                                    <p>It is a drawing of a jar of fresh juice...</p>
                                                    <a class="btn hvr-hover" href="user_page.php" style="background:#a5678e ">Buy Now</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="products-single fix">
                                                    <div class="box-img-hover">
                                                        ...
                                                        <div class="mask-icon">
                                                            <ul>
                                                                <li>
                                                                <a href="user_page.php" data-toggle="tooltip" style="background:#a5678e " data-placement="right" title="Add to Wishlist">
                                                                    <i class="far fa-heart"></i>
                                                                </a>
                                                            </li>
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    <h4>Space</h4>
                                                    <h5> <del>$ 60.00</del> $40.79</h5>
                                                    <p>It is a drawing of space and planets...</p>
                                                    <a class="btn hvr-hover" href="user_page.php"style="background:#a5678e ">Buy Now</a>
                                                </div>
                                            </div>
                                        </div>
